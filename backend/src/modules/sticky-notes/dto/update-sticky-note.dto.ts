...
export class UpdateStickyNoteDto {
  @ApiProperty({ description: '便利贴标题', example: '我的便利贴', required: false })
  @IsOptional()
  @IsString()
  title?: string;

  @ApiProperty({ description: '便利贴内容（HTML格式）', example: '<p>这是便利贴内容</p>', required: false })
  @IsOptional()
  @IsString()
  content?: string;
  ...
  @ApiProperty({ description: '颜色主题', enum: ['yellow', 'pink', 'blue', 'green', 'orange'], example: 'yellow', required: false })
  @IsOptional()
